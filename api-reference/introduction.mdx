...
MemSync uses JWT token-based authentication. Include your JWT token in the Authorization header for all requests:
...
<Note>
  **Coming Soon**: API keys for third-party application integration with enhanced security and easier management.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Search Memories" icon="search" href="/api-reference/endpoint/search-memories">
...
<CardGroup cols={2}>
  ...
  <Card title="Update Bio" icon="edit-3" href="/api-reference/endpoint/update-bio">
...
<CardGroup cols={2}>
  ...
  <Card title="Chat Integration" icon="messages" href="/api-reference/endpoint/chat-integration">
